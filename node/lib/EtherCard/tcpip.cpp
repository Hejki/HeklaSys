...
static PGM_P client_additionalheaderline;
static const char *client_postval;
static PGM_P client_urlbuf;
static const char *client_urlbuf_var;
static PGM_P client_hoststr;
...
void EtherCard::sendUdp (const char *data,byte datalen,word sport, byte *dip, word dport) {
...
//    } else {
//      PGM_P ahl = client_additionalheaderline;
...
//void EtherCard::browseUrl (PGM_P urlbuf, const char *urlbuf_varpart,  PGM_P hoststr, void (*callback)(byte,word,word)) {
//  browseUrl(urlbuf, urlbuf_varpart, hoststr, PSTR("Accept: text/html"), callback);
//}
//
//void EtherCard::browseUrl (PGM_P urlbuf, const char *urlbuf_varpart, PGM_P hoststr, PGM_P additionalheaderline, void (*callback)(byte,word,word)) {
...
//}
//
//void EtherCard::httpPost (PGM_P urlbuf, PGM_P hoststr, PGM_P additionalheaderline,const char *postval,void (*callback)(byte,word,word)) {
//  client_urlbuf = urlbuf;
//  client_hoststr = hoststr;
//  client_additionalheaderline = additionalheaderline;
