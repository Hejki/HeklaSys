...
//  static void browseUrl (PGM_P urlbuf, const char *urlbuf_varpart,
//		  PGM_P hoststr, PGM_P header,
//                         void (*cb)(uint8_t,uint16_t,uint16_t));
//  static void browseUrl (PGM_P urlbuf, const char *urlbuf_varpart,
//		  PGM_P hoststr,
//                         void (*cb)(uint8_t,uint16_t,uint16_t));
//  static void httpPost (PGM_P urlbuf, PGM_P hoststr,
//		  PGM_P header, const char *postval,
//                        void (*cb)(uint8_t,uint16_t,uint16_t));
...
//  static void persistTcpConnection(bool persist);
  ...
  // dns.cpp
  static bool dnsLookup (PGM_P name, bool fromRam =false);
