...
/**
 * Implementation of {@link org.springframework.data.repository.PagingAndSortingRepository} using {@link JdbcTemplate}
 */
...
//                        queryParam = new java.sql.Date(((java.util.Date) queryParam).getTime());
//                    }

                    ps.setObject(i + 1, queryParam);
                }
				return ps;
			}
		}, key);
